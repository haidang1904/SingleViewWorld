...
- (id _Nullable)on:(NSString * _Nonnull)notificationName performClosure:(void (^ _Nonnull)(NSNotification * _Null_unspecified))performClosure SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_OBJC("Swift method 'Channel.on(_:performClosure:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
- (void)setSecurityModeWithSecurity:(BOOL)security token:(NSString * _Nonnull)token completionHandler:(void (^ _Nonnull)(BOOL, NSError * _Nullable))completionHandler SWIFT_DEPRECATED_OBJC("Swift method 'Channel.setSecurityMode(security:token:completionHandler:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
- (NSString * _Nonnull)getToken SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_OBJC("Swift method 'Channel.getToken()' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
@property (nonatomic, readonly, copy) NSString * _Null_unspecified id SWIFT_DEPRECATED_OBJC("Swift property 'Application.id' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// start arguments
...
@property (nonatomic, weak) id <GamepadControlDelegate> _Nullable delegate SWIFT_DEPRECATED_OBJC("Swift property 'GamepadControl.delegate' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@property (nonatomic, readonly) BOOL connected SWIFT_DEPRECATED_OBJC("Swift property 'GamepadControl.connected' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@property (nonatomic) NSUInteger mouseEventsMinInterval SWIFT_DEPRECATED_OBJC("Swift property 'GamepadControl.mouseEventsMinInterval' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@property (nonatomic, readonly, strong) Service * _Nonnull service SWIFT_DEPRECATED_OBJC("Swift property 'GamepadControl.service' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
///
- (void)connectWithAtributes:(NSDictionary<NSString *, NSString *> * _Nullable)attributes completionHandler:(void (^ _Nullable)(NSError * _Nullable))completionHandler SWIFT_DEPRECATED_OBJC("Swift method 'GamepadControl.connect(withAtributes:completionHandler:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// Disconnect the TV
/// \param completionHandler <#completionHandler description#>
///
- (void)disconnect:(void (^ _Nullable)(NSError * _Nullable))completionHandler SWIFT_DEPRECATED_OBJC("Swift method 'GamepadControl.disconnect(_:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
///
- (void)sendGamepadKey:(enum GamepadkeyValue)key event:(enum GamepadkeyEventTypes)event keyOperation:(NSInteger)keyOperation SWIFT_DEPRECATED_OBJC("Swift method 'GamepadControl.sendGamepadKey(_:event:keyOperation:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
/// \param event Gamepad key Event Types
///
- (void)sendGamepadMoveByX:(NSInteger)byX byY:(NSInteger)byY event:(enum GamepadkeyEventTypes)event SWIFT_DEPRECATED_OBJC("Swift method 'GamepadControl.sendGamepadMove(byX:byY:event:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
@property (nonatomic, weak) id <RemoteControlDelegate> _Nullable delegate SWIFT_DEPRECATED_OBJC("Swift property 'RemoteControl.delegate' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// True if remote control is connected to device and ready to use.
@property (nonatomic, readonly) BOOL connected SWIFT_DEPRECATED_OBJC("Swift property 'RemoteControl.connected' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
@property (nonatomic, readonly) BOOL pointerEnabled SWIFT_DEPRECATED_OBJC("Swift property 'RemoteControl.pointerEnabled' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// True if IME input is currently active (meaning that some text input field is focused on TV and onscreen keyboard is shown).
@property (nonatomic, readonly) BOOL IMEActive SWIFT_DEPRECATED_OBJC("Swift property 'RemoteControl.IMEActive' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// Type of currently active IME text field on TV.
@property (nonatomic, readonly) enum IMEInputType IMECurrentType SWIFT_DEPRECATED_OBJC("Swift property 'RemoteControl.IMECurrentType' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@property (nonatomic, readonly, copy) NSString * _Nonnull IMECurrentText SWIFT_DEPRECATED_OBJC("Swift property 'RemoteControl.IMECurrentText' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@property (nonatomic, readonly) BOOL voiceSupported SWIFT_DEPRECATED_OBJC("Swift property 'RemoteControl.voiceSupported' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@property (nonatomic, readonly) BOOL gamePadSupported SWIFT_DEPRECATED_OBJC("Swift property 'RemoteControl.gamePadSupported' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@property (nonatomic, readonly) BOOL smartHubAgreement SWIFT_DEPRECATED_OBJC("Swift property 'RemoteControl.smartHubAgreement' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@property (nonatomic, readonly) BOOL imeSyncedSupported SWIFT_DEPRECATED_OBJC("Swift property 'RemoteControl.imeSyncedSupported' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@property (nonatomic, readonly) BOOL edenSupported SWIFT_DEPRECATED_OBJC("Swift property 'RemoteControl.edenSupported' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@property (nonatomic, readonly, copy) NSString * _Nullable countryCode SWIFT_DEPRECATED_OBJC("Swift property 'RemoteControl.countryCode' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
@property (nonatomic) NSUInteger mouseEventsMinInterval SWIFT_DEPRECATED_OBJC("Swift property 'RemoteControl.mouseEventsMinInterval' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// The Service object linked with device controlled by the RemoteControl instance.
@property (nonatomic, readonly, strong) Service * _Nonnull service SWIFT_DEPRECATED_OBJC("Swift property 'RemoteControl.service' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
///
- (void)connectWithAttributes:(NSDictionary<NSString *, NSString *> * _Nullable)attributes completionHandler:(void (^ _Nullable)(NSError * _Nullable))completionHandler SWIFT_DEPRECATED_OBJC("Swift method 'RemoteControl.connect(withAttributes:completionHandler:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// Disconnect from device.
/// \param completionHandler Optional closure to handle disconnection result
///
- (void)disconnect:(void (^ _Nullable)(NSError * _Nullable))completionHandler SWIFT_DEPRECATED_OBJC("Swift method 'RemoteControl.disconnect(_:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
///
- (void)sendRemoteKey:(NSString * _Nonnull)keyName command:(NSString * _Nonnull)command SWIFT_DEPRECATED_OBJC("Swift method 'RemoteControl.sendRemoteKey(_:command:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// Send given text for currently active input field on the connected device.
/// \param input The string to be sent as input.
///
- (void)sendInputString:(NSString * _Nonnull)input SWIFT_DEPRECATED_OBJC("Swift method 'RemoteControl.sendInputString(_:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// Notify connected device that the input for currently active text field has ended (equivalent to pressing “Done” button).
- (void)sendInputEnd SWIFT_DEPRECATED_OBJC("Swift method 'RemoteControl.sendInputEnd()' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
///
- (void)sendMouseMoveByX:(NSInteger)byX byY:(NSInteger)byY SWIFT_DEPRECATED_OBJC("Swift method 'RemoteControl.sendMouseMove(byX:byY:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
///
- (void)sendMouseClick:(enum ClickType)type SWIFT_DEPRECATED_OBJC("Swift method 'RemoteControl.sendMouseClick(_:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// Send voice control command to TV.
/// \param payload Raw recorded voice data.
///
- (void)sendVoice:(NSData * _Nonnull)payload SWIFT_DEPRECATED_OBJC("Swift method 'RemoteControl.sendVoice(_:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
- (void)setSecurityModeWithSecurity:(BOOL)security token:(NSString * _Nonnull)token completionHandler:(void (^ _Nonnull)(BOOL, NSError * _Nullable))completionHandler SWIFT_DEPRECATED_OBJC("Swift method 'RemoteControl.setSecurityMode(security:token:completionHandler:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
- (NSString * _Nonnull)getToken SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_OBJC("Swift method 'RemoteControl.getToken()' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
- (void)publishEdenWithEvent:(NSString * _Nonnull)event message:(id _Nullable)message SWIFT_DEPRECATED_OBJC("Swift method 'RemoteControl.publishEden(event:message:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@end
...
@interface RemoteControl (SWIFT_EXTENSION(SmartView)) <NSURLSessionDelegate, ChannelDelegate>
...
@property (nonatomic, readonly, copy) NSString * _Nullable deviceType SWIFT_DEPRECATED_OBJC("Swift property 'Service.deviceType' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
/// The model name of the service (Samsung SmartTV)
@property (nonatomic, readonly, copy) NSString * _Nonnull modelName SWIFT_DEPRECATED_OBJC("Swift property 'Service.modelName' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@property (nonatomic, readonly) BOOL voiceControlSupported SWIFT_DEPRECATED_OBJC("Swift property 'Service.voiceControlSupported' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@property (nonatomic, readonly) BOOL gamePadSupported SWIFT_DEPRECATED_OBJC("Swift property 'Service.gamePadSupported' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@property (nonatomic, readonly) BOOL smartHubAgreement SWIFT_DEPRECATED_OBJC("Swift property 'Service.smartHubAgreement' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@property (nonatomic, readonly) BOOL edenSupported SWIFT_DEPRECATED_OBJC("Swift property 'Service.edenSupported' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@property (nonatomic, readonly) BOOL imeSyncedSupported SWIFT_DEPRECATED_OBJC("Swift property 'Service.imeSyncedSupported' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@property (nonatomic, readonly, copy) NSString * _Nullable countryCode SWIFT_DEPRECATED_OBJC("Swift property 'Service.countryCode' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
- (RemoteControl * _Nullable)createRemoteControl SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_OBJC("Swift method 'Service.createRemoteControl()' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// Creates Gamepad Control for the device represented by the service
///
/// returns:
/// A GamepadControl instance to support API
- (GamepadControl * _Nullable)createGamepadControl SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_OBJC("Swift method 'Service.createGamepadControl()' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
- (void)setSecurityModeWithSecurity:(BOOL)security completionHandler:(void (^ _Nonnull)(BOOL, NSError * _Nullable))completionHandler SWIFT_DEPRECATED_OBJC("Swift method 'Service.setSecurityMode(security:completionHandler:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
- (void)setSecurityModeWithSecurity:(BOOL)security token:(NSString * _Nonnull)token completionHandler:(void (^ _Nonnull)(BOOL, NSError * _Nullable))completionHandler SWIFT_DEPRECATED_OBJC("Swift method 'Service.setSecurityMode(security:token:completionHandler:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
/// returns:
/// An observer handler for removing/unsubscribing the block from notifications
- (id _Nonnull)on:(NSString * _Nonnull)notificationName performClosure:(void (^ _Nonnull)(NSNotification * _Null_unspecified))performClosure SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_OBJC("Swift method 'ServiceSearch.on(_:performClosure:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
